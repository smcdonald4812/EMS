...
public class EMSGUI {
	...
	private Label newEmpFormLabel, newEmpFirstLabel,
			...
			newManagerNameLabel, newManagerLabel, 
	...
	private TextField newEmpFirstText, newEmpLastText, newEmpAddressText, 
			...
			editEmployeePayText, newManagerDepartmentText, newManagerLastText, newManagerFirstText, newDepartmentNameText,
	...
	private void buttons() {
		...
		newDepartmentSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				modify.insertDepartmentTable(newDepartmentNameText.getText());
